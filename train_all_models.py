"""
MASTER TRAINING SCRIPT - Train All 4 Models for Professor Demo

This script trains all 4 models with MLflow tracking:
...
def train_model_4_match_outcome():
    """Train Match Outcome Predictor"""
    print_header("MODEL 4: MATCH OUTCOME PREDICTOR")
...
def main():
    ...
    print(f"Training all 4 models with MLflow tracking...\n")
    ...
    # Train Model 4: Match Outcome Predictor
    results["Model 4: Match Outcome Predictor"] = train_model_4_match_outcome()
